class Object:
    ...
    def move(self, direction):
        ...
        # If direction is north and we're not in the top row,
        # move up one row
        if direction == "north" and self.row > 0:
            self.row -= 1

        # If direction is south and we're not in the last row,
        # then move down one row
        elif direction == "south" and self.row < self.display.rows - 1:
            self.row += 1

        # If direction is west and we're not in the far-left column,
        # move left one column
        elif direction == "west" and self.col > 0:
            self.col -= 1

        # If direction is east and we're not in the far-right column,
        # move right one column
        elif direction == "east" and self.col < self.display.cols - 1:
            self.col += 1

        # Place ourself in the updated grid position
